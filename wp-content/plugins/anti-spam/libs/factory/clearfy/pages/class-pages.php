 ...
 */
class Wbcr_FactoryClearfy218_PageBase extends Wbcr_FactoryPages426_ImpressiveThemplate {
	 ...
	 *
	 * @param Wbcr_Factory426_ScriptList $scripts
	 * @param Wbcr_Factory426_StyleList  $styles
	 *
	 * @return void
	...
	public function assets( $scripts, $styles ) {
		...
		$this->styles->add( FACTORY_CLEARFY_218_URL . '/assets/css/clearfy-base.css' );
		...
		wbcr_factory_426_do_action_deprecated( 'wbcr_clearfy_page_enqueue_scripts', [
			$this->getResultId(),
			$scripts,
			$styles
	...
	/**
	 * @return Wbcr_Factory426_Request
	 */
	...
	public function showBusinessSuggetionWidget() {
		...
		$default_features = [
			'4_premium'         => __( '4 premium components now;', 'wbcr_factory_clearfy_218' ),
			'40_premium'        => __( '40 new premium components within a year for the single price;', 'wbcr_factory_clearfy_218' ),
			'multisite_support' => __( 'Multisite support;', 'wbcr_factory_clearfy_218' ),
			'advance_settings'  => __( 'Advanced settings;', 'wbcr_factory_clearfy_218' ),
			'no_ads'            => __( 'No ads;', 'wbcr_factory_clearfy_218' ),
			'perfect_support'   => __( 'Perfect support.', 'wbcr_factory_clearfy_218' )
		];

		/**
		 * @since 2.0.8 - added
		 */
		$suggetion_title = __( 'MORE IN CLEARFY <span>BUSINESS</span>', 'wbcr_factory_clearfy_218' );
		 ...
		 */
		$suggetion_features = wbcr_factory_426_apply_filters_deprecated( 'wbcr/clearfy/page_bussines_suggetion_features', [
			$default_features,
		...
		?>
        <div class="wbcr-factory-sidebar-widget wbcr-factory-clearfy-218-pro-suggettion">
            ...
            <a href="<?php echo $purchase_url ?>" class="wbcr-factory-purchase-premium" target="_blank"
               rel="noopener">
				<?php printf( __( 'Upgrade for $%s', 'wbcr_factory_clearfy_218' ), $upgrade_price ) ?>
            </a>
        </div>
		<?php
	}
        ...
        <div class="wbcr-factory-sidebar-widget">
            <ul>
                <li>
                    ...
                    - <?php _e( 'A neutral setting that can not harm your site, but you must be sure that you need to use it.', 'wbcr_factory_clearfy_218' ); ?>
                </li>
                <li>
                    ...
                    - <?php _e( 'When set this option, you must be careful. Plugins and themes may depend on this function. You must be sure that you can disable this feature for the site.', 'wbcr_factory_clearfy_218' ); ?>
                </li>
                <li>
                    ...
                    - <?php _e( 'Absolutely safe setting, We recommend to use.', 'wbcr_factory_clearfy_218' ); ?>
                </li>
            </ul>
            ----------<br>
            <p><?php _e( 'Hover to the icon to get help for the feature you selected.', 'wbcr_factory_clearfy_218' ); ?></p>
        </div>
		<?php
	}
	...
	public function showRatingWidget( array $args ) {
        ...
        <div class="wbcr-factory-sidebar-widget">
            <p>
                <strong><?php _e( 'Do you want the plugin to improved and update?', 'wbcr_factory_clearfy_218' ); ?></strong>
            </p>
            <p><?php _e( 'Help the author, leave a review on wordpress.org. Thanks to feedback, I will know that the plugin is really useful to you and is needed.', 'wbcr_factory_clearfy_218' ); ?></p>
            <p><?php _e( 'And also write your ideas on how to extend or improve the plugin.', 'wbcr_factory_clearfy_218' ); ?></p>
            <p>
                <i class="wbcr-factory-icon-5stars"></i>
                <a href="<?= $page_url ?>" title="Go rate us" target="_blank">
                    <strong><?php _e( 'Go rate us and push ideas', 'wbcr_factory_clearfy_218' ); ?></strong>
                </a>
            </p>
        </div>
		<?php
	...
	public function showDonateWidget() {
        ...
        <div class="wbcr-factory-sidebar-widget">
            <p>
                <strong><?php _e( 'Donation for plugin development', 'wbcr_factory_clearfy_218' ); ?></strong>
            </p>
			<?php if ( get_locale() !== 'ru_RU' ): ?>
                <form id="wbcr-factory-paypal-donation-form" action="https://www.paypal.com/cgi-bin/webscr"
                    ...
                    <input type="image" src="<?= FACTORY_PAGES_426_URL ?>/templates/assets/img/paypal-donate.png"
