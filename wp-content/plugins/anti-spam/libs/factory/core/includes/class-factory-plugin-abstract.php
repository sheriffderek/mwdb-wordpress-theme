 ...
 *
 */
abstract class Wbcr_Factory426_Plugin extends Wbcr_Factory426_Base {

	/**
	 * Instance class Wbcr_Factory426_Request, required manages http requests
	 *
	 * @see https://webcraftic.atlassian.net/wiki/spaces/FFD/pages/390561806
	 * @var Wbcr_Factory426_Request
	 */
	public $request;

	/**
	 * @see https://webcraftic.atlassian.net/wiki/spaces/FFD/pages/393936924
	 * @var \WBCR\Factory_426\Premium\Provider
	 */
	public $premium;
	 ...
	 *
	 * @var Wbcr_FactoryBootstrap427_Manager
	 */
	public $bootstrap;
	 ...
	 * The Bootstrap Manager class
	 *
	 * @var Wbcr_FactoryForms424_Manager
	 */
	public $forms;

	/**
	 * Простой массив со списком зарегистрированных классов унаследованных от Wbcr_Factory426_Activator.
	 * Классы активации используются для упаковки набора функций, которые нужно выполнить во время
	 * активации плагина.
	 *
	 * @var array[] Wbcr_Factory426_Activator
	 */
	...
	public function __construct($plugin_path, $data)
	{
		...
		$this->request = new Wbcr_Factory426_Request();
		//$this->route = new Wbcr_Factory426_Route();
	 ...
	 *
	 * @param Wbcr_FactoryBootstrap427_Manager $bootstrap
	 */
	public function setBootstap(Wbcr_FactoryBootstrap427_Manager $bootstrap)
	{
	 ...
	 *
	 * @param Wbcr_FactoryForms424_Manager $forms
	 */
	public function setForms(Wbcr_FactoryForms424_Manager $forms)
	{
		$this->forms = $forms;
	}
	...
	{
		if( !isset(WBCR\Factory_426\Premium\Manager::$providers[$name]) ) {
			WBCR\Factory_426\Premium\Manager::$providers[$name] = $class_name;
		}
	}
	...
	{
		if( !isset(WBCR\Factory_426\Updates\Upgrader::$repositories[$name]) ) {
			WBCR\Factory_426\Updates\Upgrader::$repositories[$name] = $class_name;
		}
	}
	...
	{
		return new Wbcr_Factory426_ScriptList($this);
	}

	public function newStyleList()
	{
		return new Wbcr_Factory426_StyleList($this);
	}
	 ...
	 * Wbcr_FactoryPages426_AdminPage, а затем регистрирует его через этот метод.
	 ...
	 *                             Регистрируемый класс должен быть унаследован от класса Wbcr_FactoryPages426_AdminPage.
	...
	public function registerPage($class_name, $file_path)
	{
		...
		if( !class_exists('Wbcr_FactoryPages426') ) {
			throw new Exception('The factory_pages_426 module is not included.');
		}

		Wbcr_FactoryPages426::register($this, $class_name);
	}
	...
	public function activation_hook()
	{
		 ...
		 */
		if( apply_filters("wbcr/factory_426/cancel_plugin_activation_{$this->plugin_name}", false) ) {
			return;
		}

		/**
		 * wbcr_factory_426_plugin_activation
		 *
		 * @since 4.1.1 - deprecated
		 */
		wbcr_factory_426_do_action_deprecated('wbcr_factory_426_plugin_activation', [
			$this
		 ...
		 */
		wbcr_factory_426_do_action_deprecated('wbcr/factory/plugin_activation', [
			$this
		 ...
		 * @since 4.1.2 - deprecated
		 */
		wbcr_factory_426_do_action_deprecated("wbcr/factory/plugin_{$this->plugin_name}_activation", [
			$this
		], '4.1.2', "wbcr/factory/before_plugin_{$this->plugin_name}_activation");

		/**
		 * wbcr_factory_426_plugin_activation_' . $this->plugin_name
		 *
		 * @since 4.1.1 - deprecated
		 */
		wbcr_factory_426_do_action_deprecated('wbcr_factory_426_plugin_activation_' . $this->plugin_name, [
			$this
	...
	public function deactivation_hook()
	{
		 ...
		 * @since 4.1.1 - change  hook name
		 */
		if( apply_filters("wbcr/factory_426/cancel_plugin_deactivation_{$this->plugin_name}", false) ) {
			return;
		}

		/**
		 * wbcr_factory_426_plugin_deactivation
		 *
		 * @since 4.1.1 - deprecated
		 */
		wbcr_factory_426_do_action_deprecated('wbcr_factory_426_plugin_deactivation', [
			$this
		 ...
		 * @since 4.1.2 - deprecated
		 */
		wbcr_factory_426_do_action_deprecated('wbcr/factory/plugin_deactivation', [
			$this
		...
		/**
		 * wbcr_factory_426_plugin_deactivation_ . $this->plugin_name
		 *
		 * @since 4.1.1 - deprecated
		 */
		wbcr_factory_426_do_action_deprecated('wbcr_factory_426_plugin_deactivation_' . $this->plugin_name, [
			$this
		 ...
		 * @since 4.1.2 - deprecated
		 */
		wbcr_factory_426_do_action_deprecated("wbcr/factory/plugin_{$this->plugin_name}_deactivation", [
			$this
	...
	public function getPluginPageUrl($page_id, $args = [])
	{
		...
		return Wbcr_FactoryPages426::getPageUrl($this, $page_id, $args);
	}
	...
	private function init_framework_modules()
	{
		 ...
		 * @since 4.1.1 - deprecated
		 */
		wbcr_factory_426_do_action_deprecated('wbcr_factory_426_core_modules_loaded-' . $this->plugin_name, [], '4.1.1', "wbcr/factory_426/modules_loaded-" . $this->plugin_name);

		/**
		 * @since 4.1.1 - add
		 */
		do_action('wbcr/factory_426/modules_loaded-' . $this->plugin_name);
	}
	...
	private function register_plugin_hooks()
	{
		...
		if( is_admin() ) {
			add_filter('wbcr_factory_426_core_admin_allow_multisite', '__return_true');
	...
	{
		new WBCR\Factory_426\Migrations($this);
	}
	...
	{
		new Wbcr\Factory_426\Notices($this);
	}
	...
	{
		if( $this->has_updates ) {
			new WBCR\Factory_426\Updates\Upgrader($this);
		}
	}
	...
	protected function init_plugin_premium_features()
	{
		...
		$this->premium = WBCR\Factory_426\Premium\Manager::instance($this, $this->license_settings);

		// Подключаем премиум апгрейдер
		if( isset($this->license_settings['has_updates']) && $this->license_settings['has_updates'] ) {
			new WBCR\Factory_426\Updates\Premium_Upgrader($this);
		}
	}
}
