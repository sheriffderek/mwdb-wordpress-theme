<?php
	...
	if( !class_exists('Wbcr_FactoryForms424_Bootstrap3FormLayout') ) {
		/**
		 * A form layout based on Twitter Bootstrap 3
		 */
		class Wbcr_FactoryForms424_Bootstrap3FormLayout extends Wbcr_FactoryForms424_FormLayout {
			...
			/**
			 * @param Wbcr_FactoryForms424_Control $control
			 */
