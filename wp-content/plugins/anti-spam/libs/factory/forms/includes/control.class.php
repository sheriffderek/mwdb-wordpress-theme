<?php
	...
	if( !class_exists('Wbcr_FactoryForms424_Control') ) {
		 ...
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryForms424_Control extends Wbcr_FactoryForms424_FormElement {
			 ...
			 *
			 * @param mixed[] $options
			 * @param FactoryForms424_Form $form
			 * @param null $provider
			 * @since 1.0.0
			 * @return void
			 */
			 ...
			 *
			 * @since 1.0.0
			 * @param IFactoryForms424_ValueProvider $provider
			 * @return void
			 */
