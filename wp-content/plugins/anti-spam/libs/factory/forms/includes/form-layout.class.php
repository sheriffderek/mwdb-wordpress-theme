<?php
	...
	if( !class_exists('Wbcr_FactoryForms424_FormLayout') ) {

		/**
		 * The base class for all form layouts.
		 */
		abstract class Wbcr_FactoryForms424_FormLayout extends Wbcr_FactoryForms424_Holder {
			...
			public function __construct($options, $form)
			{
				...
				$this->addCssClass('factory-forms-424-' . $this->type);
				$this->addCssClass('factory-forms-424-' . $this->name);
			}
