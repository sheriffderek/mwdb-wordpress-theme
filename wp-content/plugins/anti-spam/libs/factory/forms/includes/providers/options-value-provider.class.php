<?php
	...
	if( !class_exists('Wbcr_FactoryForms424_OptionsValueProvider') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms424_OptionsValueProvider implements Wbcr_IFactoryForms424_ValueProvider {
