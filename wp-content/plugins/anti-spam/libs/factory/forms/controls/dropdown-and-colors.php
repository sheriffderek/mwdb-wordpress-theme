<?php
	 ...
	 *  // see FactoryForms424_DropdownControl
	 * 'dropdown' => array(
	 ...
	 *    ),
	 * // see FactoryForms424_RadioColorsControl
	 * 'colors' => array(
	 *   // a callback to return items or an array of items to select
	 *   'data' => array(
	...
	if( !class_exists('Wbcr_FactoryForms424_DropdownAndColorsControl') ) {
		
		class Wbcr_FactoryForms424_DropdownAndColorsControl extends Wbcr_FactoryForms424_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->dropdown = new Wbcr_FactoryForms424_DropdownControl($options['dropdown'], $form, $provider);
				$this->colors = new Wbcr_FactoryForms424_RadioColorsControl($options['colors'], $form, $provider);
