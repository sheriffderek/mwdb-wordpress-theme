<?php
	...
	if( !class_exists('Wbcr_FactoryForms424_GradientControl') ) {
		class Wbcr_FactoryForms424_GradientControl extends Wbcr_FactoryForms424_Control {
			...
			public function html()
			{
				...
				<script>
					...
					factory.res.resVertical = '<?php _e( 'vertical', 'wbcr_factory_forms_424' ) ?>';
					factory.res.resHorizontal = '<?php _e( 'horizontal', 'wbcr_factory_forms_424' ) ?>';
				</script>
				<div <?php $this->attrs() ?>>
