<?php
	...
	if( !class_exists('Wbcr_FactoryForms424_ColorAndOpacityControl') ) {
	}

	class Wbcr_FactoryForms424_ColorAndOpacityControl extends Wbcr_FactoryForms424_ComplexControl {
		...
		public function __construct($options, $form, $provider = null)
		{
			...
			$this->opacity = new Wbcr_FactoryForms424_IntegerControl($options['opacity'], $form, $provider);
