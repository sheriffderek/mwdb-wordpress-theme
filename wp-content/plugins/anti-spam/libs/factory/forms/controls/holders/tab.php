<?php
	...
	if( !class_exists('Wbcr_FactoryForms424_TabHolder') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms424_TabHolder extends Wbcr_FactoryForms424_Holder {
			 ...
			 * @param FactoryForms424_Form $form A parent form.
			 */
				...
				<div class="factory-headers">
					<ul class="nav nav-tabs">
						<?php foreach($this->elements as $element) {
							...
							$builder = new Wbcr_FactoryForms424_HtmlAttributeBuilder();
