<?php
	...
	if( !class_exists('Wbcr_FactoryForms424_DatepickerRangeControl') ) {

		class Wbcr_FactoryForms424_DatepickerRangeControl extends Wbcr_FactoryForms424_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->range_1 = new Wbcr_FactoryForms424_TextboxControl($options['range_1'], $form, $provider);
				$this->range_2 = new Wbcr_FactoryForms424_TextboxControl($options['range_2'], $form, $provider);
