<?php
	...
	if( !class_exists('Wbcr_FactoryForms424_WpEditorControl') ) {

		class Wbcr_FactoryForms424_WpEditorControl extends Wbcr_FactoryForms424_Control {
			...
			protected function beforeHtml()
			{
				...
				if( !isset($this->options['tinymce']['content_css']) ) {
					$this->options['tinymce']['content_css'] = FACTORY_FORMS_424_URL . '/assets/css/editor.css';
				}
			}
