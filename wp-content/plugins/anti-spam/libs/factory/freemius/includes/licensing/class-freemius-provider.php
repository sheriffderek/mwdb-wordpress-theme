...
namespace WBCR\Factory_Freemius_114\Premium;

use WBCR\Factory_Freemius_114\Entities\License;
use WBCR\Factory_Freemius_114\Entities\Plugin;
use WBCR\Factory_Freemius_114\Entities\Site;
use WBCR\Factory_Freemius_114\Entities\User;
use WBCR\Factory_426\Premium\Provider as License_Provider;
use Wbcr_Factory426_Plugin;
use WBCR\Factory_Freemius_114\Api;
use WP_Error;
use Exception;
...
final class Provider extends License_Provider {
	...
	/**
	 * @var \WBCR\Factory_Freemius_114\Api
	 */
	private $site_api;
	 ...
	 * @throws Exception
	 */
	public function __construct( Wbcr_Factory426_Plugin $plugin, array $settings ) {
	...
	/**
	 * @return \WBCR\Factory_Freemius_114\Entities\License|null
	 * @throws Exception
	 */
	 ...
	 * @param bool $flush
	 *
	 * @return \WBCR\Factory_Freemius_114\Api
	 * @throws Exception
	 */
