...
namespace WBCR\Factory_Freemius_114\Updates;

// Exit if accessed directly
use Exception;
use Wbcr_Factory426_Plugin;
use WBCR\Factory_426\Updates\Repository;
...
class Freemius_Repository extends Repository {
	...
	/**
	 * @var \WBCR\Factory_Freemius_114\Premium\Provider
	 */
	private $premium;
	...
	public function init() {
		if ( ! $this->premium instanceof \WBCR\Factory_Freemius_114\Premium\Provider ) {
