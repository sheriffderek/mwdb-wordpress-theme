...
namespace WBCR\Factory_Freemius_114;
...
final class Api {
	...
	/**
	 * @param Wbcr_Factory426_Plugin $slug
	 ...
	 */
	private function __construct( Wbcr_Factory426_Plugin $plugin, $scope, $id, $public_key, $secret_key, $is_sandbox ) {
	 ...
	 * @return Api
	 */
	public static function instance( Wbcr_Factory426_Plugin $plugin, $scope, $id, $public_key, $is_sandbox, $secret_key = false ) {
