(function($) {
	...
	$.fn.factoryBootstrap427_dropdownAndColors = function(option) {
		// call an method
	...
	$.fn.factoryBootstrap427_dropdownAndColors.Constructor = dropdownAndColors;

	$(function() {
		$(".factory-bootstrap-427 .factory-dropdown-and-colors").factoryBootstrap427_dropdownAndColors();
	});
