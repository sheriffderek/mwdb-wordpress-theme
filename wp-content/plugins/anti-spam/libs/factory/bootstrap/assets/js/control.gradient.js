( function( $ ){
    ...
    $.fn.factoryBootstrap427_gradientControl = function (option) {
    ...
    $.fn.factoryBootstrap427_gradientControl.Constructor = GradientControl;
    
    // GRADIENT CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-427 .factory-gradient").factoryBootstrap427_gradientControl();
    });
