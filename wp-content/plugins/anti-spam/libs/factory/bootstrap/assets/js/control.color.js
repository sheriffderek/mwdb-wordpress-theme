...
;( function( $ ){
    ...
    $.widget( "factoryBootstrap427.colorControl", {
        ...
        _init: function( event ) {
            ...
            this.$picker.factoryBootstrap427_iris(irisOptions); 
            this.$picker.off('focus');

            $(document).on("click.color.factory", function(){
               self.$picker.factoryBootstrap427_iris("hide");  
            });

            this.$picker.add(this.$background).on("click.color.factory", function(e){
               e.stopPropagation();
               self.$picker.factoryBootstrap427_iris("show");  
            });  
        },
        ...
        hidePicker: function() {
            ...
            this.$picker.factoryBootstrap427_iris( 'hide' );
        }, 

        showPicker: function() {
            this.$element.addClass('factory-picker-active');
            this.$picker.factoryBootstrap427_iris( 'show' );
        },
    ...
    $(function(){
        $.widget.bridge( "factoryBootstrap427_colorControl", $.factoryBootstrap427.colorControl );
        $(".factory-bootstrap-427 .factory-color").factoryBootstrap427_colorControl({});
    });
