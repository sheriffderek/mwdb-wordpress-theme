...
;( function( $ ){
    ...
    $.widget( "factoryBootstrap427.fontControl", {
    ...
    $(function(){
        $.widget.bridge( "factoryBootstrap427_fontControl", $.factoryBootstrap427.fontControl );
        $(".factory-bootstrap-427 .factory-font").factoryBootstrap427_fontControl({});
    });
