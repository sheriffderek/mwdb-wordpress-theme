( function( $ ){
    ...
    $.fn.factoryBootstrap427_integerControl = function (option) {
    ...
    $.fn.factoryBootstrap427_integerControl.Constructor = IntegerControl;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-427 .factory-integer").factoryBootstrap427_integerControl();
    });
