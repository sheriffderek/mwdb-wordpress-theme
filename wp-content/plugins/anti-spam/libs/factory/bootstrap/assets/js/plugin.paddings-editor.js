( function( $ ){
    ...
    $.fn.factoryBootstrap427_paddingsEditor = function (option) {
    ...
    $.fn.factoryBootstrap427_paddingsEditor.Constructor = PaddingsEditor;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-427 .factory-paddings-editor").factoryBootstrap427_paddingsEditor();
    });
