( function($) {
	...
	$.fn.factoryBootstrap427_checkboxControl = function(option) {
	...
	$.fn.factoryBootstrap427_checkboxControl.Constructor = CheckboxControl;

	// AUTO CREATING
	// ================================

	$(function() {
		$(".factory-bootstrap-427 .factory-checkbox.factory-buttons-way").factoryBootstrap427_checkboxControl();
	});
