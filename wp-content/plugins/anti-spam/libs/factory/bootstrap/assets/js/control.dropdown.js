( function($) {
	...
	$.fn.factoryBootstrap427_dropdownControl = function(option) {
	...
	$.fn.factoryBootstrap427_dropdownControl.Constructor = DropdownControl;

	// AUTO CREATING
	// ================================

	$(function() {
		$(".factory-bootstrap-427 .factory-dropdown").factoryBootstrap427_dropdownControl();
	});
