...
;( function( $ ){
    ...
    $.widget( "factoryBootstrap427.patternControl", {
        ...
        showColorPanel: function() {
            ...
            this.$colorResult.val( this.$colorContol.factoryBootstrap427_colorControl('getValue') );
            this.$colorResult.trigger('change');
            this.$element.trigger('change');
        },
    ...
    $(function(){
        $.widget.bridge( "factoryBootstrap427_patternControl", $.factoryBootstrap427.patternControl );
        $(".factory-bootstrap-427 .factory-pattern").factoryBootstrap427_patternControl({});
    });
