	...
	GradientSelection.prototype = {    
		...
		this.g2d = canvas.getContext("2d");
            ...
            _createColorPicker: function() {
                ...
                this.$colorPicker.factoryBootstrap427_iris({
                    width: 217,
                ...
                self.$colorHex.on('change paste keyup', function(){
                    ...
                    self.$colorPicker.factoryBootstrap427_iris('color', self.$colorHex.val());
		...
		this.$el.append( this.$directionDropdown );  
            ...
            showColorPicker: function( point ) {
                ...
                this.$colorPicker.factoryBootstrap427_iris( 'show' );
                this.$colorPicker.factoryBootstrap427_iris( 'option', 'color', point.color );
