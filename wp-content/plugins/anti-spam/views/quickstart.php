 ...
 * @var array                       $scanner
 * @var Wbcr_Factory426_Plugin      $this_plugin
 */
	        ...
	        <tr>
		        <td>
			        ...
			        <div class="wt-right-block">
				        <div id="wtitan-circle-firewall-coverage" class="wtitan-status-circular">
					        <svg viewBox="0 0 100 100" style="display: inline-block; width: 100px; height: 100px; opacity: 1;" viewbox="0 0 100 100"><path class="wtitan-status-circular-inactive-path" d="M 50,50 m 0,-48 a 48,48 0 1 1 0,96 a 48,48 0 1 1 0,-96" stroke="#ececec" stroke-width="1" fill-opacity="0"></path><path class="wtitan-status-circular-active-path" d="M 50,50 m 0,-48 a 48,48 0 1 1 0,96 a 48,48 0 1 1 0,-96" stroke="#5d05b7" stroke-width="1" stroke-dasharray="301.59289474462014,301.59289474462014" stroke-dashoffset="-301.59289474462014" fill-opacity="0" style="stroke-dashoffset: -301.593px;"></path><path class="wtitan-status-circular-terminator" d="M 50,2 m 0,-1 a 1,1 0 1 1 0,2 a 1,1 0 1 1 0,-2" stroke="#5d05b7" stroke-width="1" fill="#ffffff"></path></svg>
		        ...
		        <td>
			        <div class="wt-full-block">
				        <div class="wt-left-block">
					        <h4><span class="dashicons dashicons-plugins-checked"></span><?php echo __('Security audit','titan-security'); ?> (<?php echo $audit->get_count(); ?>)</h4>
					        <div class="wt-block-span"><?php if($audit->get_count()) echo __('Security issues detected!','titan-security'); ?></div>
				        </div>
				        <div class="wt-right-block">
